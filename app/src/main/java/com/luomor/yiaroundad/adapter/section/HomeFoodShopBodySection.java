 ...
 * 首页美食界面内容Section
 */
public class HomeFoodShopBodySection extends StatelessSection {
    private Context mContext;
    private List<ShopListInfo.ResultBean.AdBean.BodyBean> foodbobys;

    public HomeFoodShopBodySection(Context context, List<ShopListInfo.ResultBean.AdBean.BodyBean> foodbobys) {
        super(R.layout.layout_home_food_shop_body, R.layout.layout_home_recommend_empty);
