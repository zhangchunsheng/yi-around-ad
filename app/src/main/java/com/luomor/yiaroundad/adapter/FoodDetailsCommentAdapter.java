...
/**
 * Created by Peter on 18/6/2 14:12
 * 1097692918@qq.com
 * <p/>
 * 美食详情美食评论adapter
 */
public class FoodDetailsCommentAdapter extends AbsRecyclerViewAdapter {
    private List<FoodDetailsCommentInfo.DataBean.RepliesBean> replies;

    public FoodDetailsCommentAdapter(RecyclerView recyclerView, List<FoodDetailsCommentInfo.DataBean.RepliesBean> replies) {
        super(recyclerView);
