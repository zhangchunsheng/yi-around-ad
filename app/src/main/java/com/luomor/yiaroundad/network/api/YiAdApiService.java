...
import com.luomor.yiaroundad.entity.food.SpecialTopicIResult;
...
public interface YiAdApiService {
     ...
     */
    @GET("spview")
    Observable<SpecialTopicIResult> getSpItemList(@Query("spid") int spid, @Query("season_id") int season_id, @Query("food") int food);
