        ...
        RetrofitHelper.getYiLiveAPI()
                ...
                .map(responseBody -> {
                    try {
                        ...
                        //https://i3.yongche.name/media/g2/M01/1D/26/rBEBP1q-I9yIFhbsACHbIxXLhwMAALhDACGphUAIds7350.mp4
                        ...
                        String result = "https://i3.yongche.name/media/g2/M01/1D/26/rBEBP1q-I9yIFhbsACHbIxXLhwMAALhDACGphUAIds7350.mp4";
                        return result;
                    } catch (IOException e) {
                        e.printStackTrace();
                        return null;
