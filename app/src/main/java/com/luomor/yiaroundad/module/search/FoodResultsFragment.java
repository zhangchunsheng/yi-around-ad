 ...
 * 美食搜索内容列表界面
 */
public class FoodResultsFragment extends RxLazyFragment {
    ...
    private List<SearchFoodInfo.DataBean.ItemsBean> foods = new ArrayList<>();

    public static FoodResultsFragment newInstance(String content) {
    ...
    protected void loadData() {
        RetrofitHelper.getBiliAppAPI()
                ...
                .subscribe(dataBean -> {
                    foods.addAll(dataBean.getItems());
                    finishTask();
                }, throwable -> {
                    hideSearchAnim();
                    showEmptyView();
