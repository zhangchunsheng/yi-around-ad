...
public class VersionManagementUtil {
    ...
    /**
     *
     * @param versionServer String
     * @param versionLocal String
    ...
    public void Update(String url, Callback callback) {
        ...
        UpgradeManager upgradeManager = new UpgradeManager(mContext);
        upgradeManager.checkUpdateInfo(url, callback);
    }
}
